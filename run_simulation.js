...
const run = async()=>{
    ...
    // const strategy4Id = 'JustAddSomeAndWithdrawFast';
    const strategyId = 'AddALittleEachEpoch';
    const strategy2Id = 'AddALittleEachEpoch';
    const strategy3Id = 'Stake5PlusUnstake10';
    const strategy4Id = 'Stake5PlusUnstake10';

    const waitTillEpoch = 5;// 5; // do not trade on first N epoch, as we can start on different one
    const simulateNEpochs = 50;
